...
namespace Nqey.DAL.Migrations
{
    ...
    [Migration("20250529175316_AddedJobDescripIdToReservationModel")]
    partial class AddedJobDescripIdToReservationModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nqey.Domain.Reservation", b =>
                {
                    ...
                    b.HasOne("Nqey.Domain.JobDescription", "JobDescription")
                        .WithOne("Reservation")
                        .HasForeignKey("Nqey.Domain.Reservation", "JobDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
